...
verse = 'Пара-ра-рам Рам-пам-папам Па-реа-па-дам'

verse = verse.lower().split()
print(verse)
num = list(sum(x in 'уеыаоэяию' for x in y) for y in verse)
print(num)

print("Парам пам-пам" if len(set(num)) == 1 else "Пам парам")
